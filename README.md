...
以下所有测试程序的编译均需要编译工具“riscv64-unknown-linux-gnu-gcc”, 可以选择使用已有的chipyard环境中的工具链.
...
进入官方 coremark 仓库并编译 RISC-V 可执行文件.
...
生成 RISC-V 版本可执行文件`coremark/coremark.riscv`
...
生成 RISC-V 版本可执行文件`benchmark-dhrystone/dhrystone`

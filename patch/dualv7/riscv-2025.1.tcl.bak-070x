...
# module references:
# $rocket_module_name, mem_reset_control, ethernet, sdc_controller, uart, ethernet_dualv7
...
proc write_mig_file_riscv_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   # DualV7 MIG PRJ: validated configuration for xc7v2000t-flg1925/-1
   # TimePeriod=2500 (DDR3-800), MemPart=MT41K256M16XX-125, DataWidth=64
   file copy "../../board/dualv7/mig.prj" "$str_mig_prj_filepath"
}
...
# Hierarchical cell: EthernetDualV7
proc create_hier_cell_EthernetDualV7 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_EthernetDualV7() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -type clk phy_tx_clk
  create_bd_pin -dir I -type clk phy_rx_clk
  create_bd_pin -dir O -from 3 -to 0 mii_txd
  create_bd_pin -dir O mii_tx_en
  create_bd_pin -dir I -from 3 -to 0 mii_rxd
  create_bd_pin -dir I mii_rx_dv
  create_bd_pin -dir I mii_rx_er
  create_bd_pin -dir I mii_col
  create_bd_pin -dir I mii_crs
  create_bd_pin -dir I -type rst reset
  create_bd_pin -dir O -from 15 -to 0 status_vector

  # Create instance: ethernet_stream_0, and set properties
  set block_name ethernet_dualv7
  ...
  connect_bd_net -net eth_clock [get_bd_pins clock] [get_bd_pins ethernet_stream_0/clock]
  connect_bd_net -net eth_reset [get_bd_pins reset] [get_bd_pins ethernet_stream_0/reset]
  connect_bd_net -net phy_tx_clk_net [get_bd_pins phy_tx_clk] [get_bd_pins ethernet_stream_0/phy_tx_clk]
  connect_bd_net -net phy_rx_clk_net [get_bd_pins phy_rx_clk] [get_bd_pins ethernet_stream_0/phy_rx_clk]
  connect_bd_net -net mii_txd_net [get_bd_pins mii_txd] [get_bd_pins ethernet_stream_0/mii_txd]
  connect_bd_net -net mii_tx_en_net [get_bd_pins mii_tx_en] [get_bd_pins ethernet_stream_0/mii_tx_en]
  connect_bd_net -net mii_rxd_net [get_bd_pins mii_rxd] [get_bd_pins ethernet_stream_0/mii_rxd]
  connect_bd_net -net mii_rx_dv_net [get_bd_pins mii_rx_dv] [get_bd_pins ethernet_stream_0/mii_rx_dv]
  connect_bd_net -net mii_rx_er_net [get_bd_pins mii_rx_er] [get_bd_pins ethernet_stream_0/mii_rx_er]
  connect_bd_net -net mii_col_net [get_bd_pins mii_col] [get_bd_pins ethernet_stream_0/mii_col]
  connect_bd_net -net mii_crs_net [get_bd_pins mii_crs] [get_bd_pins ethernet_stream_0/mii_crs]
  connect_bd_net -net eth_status [get_bd_pins status_vector] [get_bd_pins ethernet_stream_0/status_vector]
...
proc create_hier_cell_IO { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 3 -to 0 ddr_status
  ...
  # Create instance: EthernetDualV7
  create_hier_cell_EthernetDualV7 $hier_obj EthernetDualV7
  ...
  # Create instance: LEDGPIO, and set properties
  set LEDGPIO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 LEDGPIO ]
  set_property -dict [ list \
  ...
  # Create instance: DDRSTAT, and set properties
  set DDRSTAT [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 DDRSTAT ]
  set_property -dict [ list \
  ...
  # UART CTSn: no board pin on DualV7; tie to 0
  set xlconstant_uart_cts [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_uart_cts ]
  set_property -dict [ list CONFIG.CONST_VAL {0} CONFIG.CONST_WIDTH {1} ] $xlconstant_uart_cts
  connect_bd_net [get_bd_pins xlconstant_uart_cts/dout] [get_bd_pins UART/CTSn]


  # Create interface connections
  connect_bd_intf_net -intf_net Ethernet_TX_AXIS [get_bd_intf_pins Ethernet/TX_AXIS] [get_bd_intf_pins EthernetDualV7/TX_AXIS]
  ...
  connect_bd_intf_net -intf_net ethernet_stream_0_RX_AXIS [get_bd_intf_pins Ethernet/RX_AXIS] [get_bd_intf_pins EthernetDualV7/RX_AXIS]
  ...
  connect_bd_intf_net -intf_net io_axi_s_M04_AXI [get_bd_intf_pins LEDGPIO/S_AXI] [get_bd_intf_pins io_axi_s/M04_AXI]
  connect_bd_intf_net -intf_net io_axi_s_M05_AXI [get_bd_intf_pins DDRSTAT/S_AXI] [get_bd_intf_pins io_axi_s/M05_AXI]
  connect_bd_net -net LEDGPIO_leds [get_bd_pins leds] [get_bd_pins LEDGPIO/gpio_io_o]
  connect_bd_net -net DDRSTAT_status [get_bd_pins ddr_status] [get_bd_pins DDRSTAT/gpio_io_i]
  connect_bd_intf_net -intf_net sd_axi_m [get_bd_intf_pins SD/M_AXI] [get_bd_intf_pins io_axi_m/S00_AXI]

  # Create port connections
  connect_bd_net -net AXI_clock [get_bd_pins axi_clock] [get_bd_pins XADC/s_axi_aclk] [get_bd_pins io_axi_m/aclk] [get_bd_pins io_axi_s/aclk] [get_bd_pins Ethernet/clock] [get_bd_pins EthernetDualV7/clock] [get_bd_pins io_axi_m/aclk2] [get_bd_pins io_axi_s/aclk2] [get_bd_pins LEDGPIO/s_axi_aclk] [get_bd_pins DDRSTAT/s_axi_aclk]
  connect_bd_net -net IO_phy_tx_clk [get_bd_pins phy_tx_clk] [get_bd_pins EthernetDualV7/phy_tx_clk]
  connect_bd_net -net IO_phy_rx_clk [get_bd_pins phy_rx_clk] [get_bd_pins EthernetDualV7/phy_rx_clk]
  connect_bd_net -net IO_mii_txd [get_bd_pins mii_txd] [get_bd_pins EthernetDualV7/mii_txd]
  connect_bd_net -net IO_mii_tx_en [get_bd_pins mii_tx_en] [get_bd_pins EthernetDualV7/mii_tx_en]
  connect_bd_net -net IO_mii_rxd [get_bd_pins mii_rxd] [get_bd_pins EthernetDualV7/mii_rxd]
  connect_bd_net -net IO_mii_rx_dv [get_bd_pins mii_rx_dv] [get_bd_pins EthernetDualV7/mii_rx_dv]
  connect_bd_net -net IO_mii_rx_er [get_bd_pins mii_rx_er] [get_bd_pins EthernetDualV7/mii_rx_er]
  connect_bd_net -net IO_mii_col [get_bd_pins mii_col] [get_bd_pins EthernetDualV7/mii_col]
  connect_bd_net -net IO_mii_crs [get_bd_pins mii_crs] [get_bd_pins EthernetDualV7/mii_crs]
  connect_bd_net -net AXI_reset [get_bd_pins axi_reset] [get_bd_pins Ethernet/async_resetn] [get_bd_pins SD/async_resetn] [get_bd_pins UART/async_resetn] [get_bd_pins XADC/s_axi_aresetn] [get_bd_pins io_axi_m/aresetn] [get_bd_pins io_axi_s/aresetn] [get_bd_pins LEDGPIO/s_axi_aresetn] [get_bd_pins DDRSTAT/s_axi_aresetn]
  ...
  connect_bd_net -net Ethernet_reset [get_bd_pins Ethernet/reset] [get_bd_pins EthernetDualV7/reset]
  connect_bd_net -net Ethernet_status_vector [get_bd_pins Ethernet/status_vector] [get_bd_pins EthernetDualV7/status_vector]
...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 3 -to 0 ddr_status
  ...
  connect_bd_net -net clock_200MHz [get_bd_pins clock_200MHz] [get_bd_pins mem_reset_control_0/clock] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins mig_7series_0/clk_ref_i]
  ...
  # DDR status xlconcat for MMIO readback
  set ddr_status_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 ddr_status_concat ]
  set_property -dict [ list CONFIG.NUM_PORTS {4} ] $ddr_status_concat
  connect_bd_net [get_bd_pins ddr_status_concat/In0] [get_bd_pins mem_reset_control_0/mem_ok]
  connect_bd_net [get_bd_pins ddr_status_concat/In1] [get_bd_pins mig_7series_0/init_calib_complete]
  connect_bd_net [get_bd_pins ddr_status_concat/In2] [get_bd_pins mig_7series_0/mmcm_locked]
  connect_bd_net [get_bd_pins ddr_status_concat/In3] [get_bd_pins mig_7series_0/ui_clk_sync_rst]
  connect_bd_net [get_bd_pins ddr_status] [get_bd_pins ddr_status_concat/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  # MII clocks (board input)
  create_bd_port -dir I -type clk phy_tx_clk
  set_property CONFIG.FREQ_HZ 25000000 [get_bd_ports phy_tx_clk]
  create_bd_port -dir I -type clk phy_rx_clk
  set_property CONFIG.FREQ_HZ 25000000 [get_bd_ports phy_rx_clk]
  ...
  create_bd_port -dir I mii_rx_er
  create_bd_port -dir I mii_col
  create_bd_port -dir I mii_crs
  ...
  # Create instance: util_vector_logic_0 (NOT gate for active-low reset)
  ...
  connect_bd_net -net ddr_status [get_bd_pins DDR/ddr_status] [get_bd_pins IO/ddr_status]
  connect_bd_net -net fan_en [get_bd_ports fan_en] [get_bd_pins IO/fan_en]
  connect_bd_net [get_bd_ports leds] [get_bd_pins IO/leds]
  ...
  connect_bd_net [get_bd_ports phy_tx_clk] [get_bd_pins IO/phy_tx_clk]
  connect_bd_net [get_bd_ports phy_rx_clk] [get_bd_pins IO/phy_rx_clk]
  connect_bd_net [get_bd_ports mii_txd] [get_bd_pins IO/mii_txd]
  connect_bd_net [get_bd_ports mii_tx_en] [get_bd_pins IO/mii_tx_en]
  connect_bd_net [get_bd_ports mii_rxd] [get_bd_pins IO/mii_rxd]
  connect_bd_net [get_bd_ports mii_rx_dv] [get_bd_pins IO/mii_rx_dv]
  connect_bd_net [get_bd_ports mii_rx_er] [get_bd_pins IO/mii_rx_er]
  connect_bd_net [get_bd_ports mii_col] [get_bd_pins IO/mii_col]
  connect_bd_net [get_bd_ports mii_crs] [get_bd_pins IO/mii_crs]
  ...
  assign_bd_address -offset 0x60040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces RocketChip/IO_AXI4] [get_bd_addr_segs IO/LEDGPIO/S_AXI/Reg] -force
  assign_bd_address -offset 0x60050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces RocketChip/IO_AXI4] [get_bd_addr_segs IO/DDRSTAT/S_AXI/Reg] -force
